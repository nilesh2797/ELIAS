...
# accelerate launch --config_file configs/accelerate.yaml --num_processes ${num_gpus} elias_utils.py gen_approx_A Results/ELIAS/${dataset}/ELIAS-1/config.yaml
...
accelerate launch --config_file configs/accelerate.yaml --num_processes ${num_gpus} eval.py Results/ELIAS/${dataset}/ELIAS-2/config.yaml
